        ...
        >
          <List>
            <Item style={{ maxWidth: 100 }}>
              <span><b style={{ fontSize: 16 }}>商品名称:</b>{name}</span>
            </Item>
            <Item style={{ maxWidth: 100 }}>
              <span><b style={{ fontSize: 16 }}>商品描述:</b>{desc}</span>
            </Item>
            <Item style={{ maxWidth: 100 }}>
              <span><b style={{ fontSize: 16 }}>商品价格:</b>{price}</span>
            </Item>
            <Item style={{ maxWidth: 100 }}>
              <span><b style={{ fontSize: 16 }}>所属分类:</b>{categoryId}</span>
            </Item>
            <Item style={{ maxWidth: 100 }}>
              <span><b style={{ fontSize: 16 }}>商品图片:</b>{imgs}</span>
            </Item>
            <Item style={{ maxWidth: 100 }}>
              <span><b style={{ fontSize: 16 }}>商品详情:</b>{detail}</span>
            </Item>
          </List>
        </Card>
